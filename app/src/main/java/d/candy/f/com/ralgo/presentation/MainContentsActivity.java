...
import d.candy.f.com.ralgo.my_test.SqliteRWTest;
...
public class MainContentsActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_contents, menu);
        return true;
    }
    ...
    private void init() {
        mDomainDirector = new DomainDirector<>(this, RequestService.class);
    }
